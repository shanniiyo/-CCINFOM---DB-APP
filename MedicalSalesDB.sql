...
INSERT INTO Product (ProductID, Brand, Quantity, Price, DateAdded, ExpirationDate, LowStockLimit) VALUES 
  ('1', 'Bandage', 100, 50.00, '2025-11-17', '2026-11-17', 10),
  ('2', 'Fujifilm Dry film HT 14x17', 10, 11000.00, '2025-11-18', '2026-06-25', 10),
  ('3', 'Agfa Drystar DT2B 14x17', 10, 22000.00, '2025-11-18', '2028-10-14', 10),
  ('4', 'Sony Thermal paper Type I/S', 100, 480.00, '2025-11-18', '2027-04-09', 10),
  ('5', 'Nitrilecare Nitrile Gloves S (Powderfree)', 100, 225.00, '2025-11-18', '2027-11-09', 10),
  ('6', 'Nitrilecare Nitrile Gloves M (Powderfree)', 100, 225.00, '2025-11-18', '2028-09-02', 10),
  ('7', 'Nitrilecare Nitrile Gloves L (Powderfree)', 100, 225.00, '2025-11-18', '2028-08-01', 10),
  ('8', 'Schullermed Nitrile Gloves S (Powderfree)', 100, 190.00, '2025-11-18', '2028-02-12', 10),
  ('9', 'Schullermed Nitrile Gloves M (Powderfree)', 100, 190.00, '2025-11-18', '2028-09-15', 10),
  ('10', 'Schullermed Nitrile Gloves L (Powderfree)', 100, 190.00, '2025-11-18', '2026-07-27', 10),
  ('11', 'Sri Trang Nitrile Gloves S (Powderfree)', 100, 190.00, '2025-11-18', '2027-05-19', 10),
  ('12', 'Rubbercare Latex Gloves S (Powderfree)', 100, 230.00, '2025-11-18', '2027-04-12', 10),
  ('13', 'Schullermed Latex Gloves M (Powderfree)', 100, 185.00, '2025-11-18', '2026-11-14', 10),
  ('14', 'Sri Trang Latex Gloves L (Powderfree)', 100, 180.00, '2025-11-18', '2026-10-10', 10),
  ('15', 'ORCare Surgical Gloves 7.5 (Powderfree)', 50, 1500.00, '2025-11-18', '2028-01-20', 10),
  ('16', 'Unimex Surgical Gloves 7.5 (Powderfree)', 50, 1000.00, '2025-11-18', '2028-04-20', 10),
  ('17', 'Careplus Facemask Earloop', 200, 70.00, '2025-11-18', '2028-04-29', 10),
  ('18', 'IV Starter Kit', 100, 85.00, '2025-11-18', '2027-10-09', 10),
  ('19', 'Syphilis Ab Rapid Test, Ds', 30, 42.20, '2025-11-18', '2028-01-08', 10),
  ('20', 'Syphilis Ab Combo Rapid Test, Cs', 30, 79.00, '2025-11-18', '2028-01-22', 10),
  ('21', 'HIV/Syphilis Ab Combo Rapid Test, Cs', 30, 131.67, '2025-11-18', '2027-01-08', 10),
  ('22', 'HIV/Syphilis/HBV/HCV Panel Rapid Test, Cs', 20, 224.00, '2025-11-18', '2027-12-14', 10),
  ('23', 'Dengue IgG/IgM Combo Rapid Test, Cs', 30, 237.00, '2025-11-18', '2028-11-09', 10),
  ('24', 'Duo Dengue Ag-IgG/IgM Rapid Test, Cs', 10, 461.00, '2025-11-18', '2027-08-16',10),
  ('25', 'Dengue Ag Rapid Test, Cs', 30, 250.00, '2025-11-18', '2027-10-18',10),
  ('26', 'HAV IgM Rapid Test, Cs', 30, 263.33, '2025-11-18', '2028-01-27', 10),
  ('27', 'HAV IgG/IgM Combo Rapid Test, Cs', 30, 316.00, '2025-11-18', '2028-09-02',10),
  ('28', 'Leptospira IgG/IgM Combo Rapid Test, Cs', 30, 329.00, '2025-11-18', '2026-09-02',10),
  ('29', 'Malaria Pf/Pv Ab Combo Rapid Test, Cs', 30, 131.67, '2025-11-18', '2026-08-01',10),
  ('30', 'Malaria Pf/Pv Ag Rapid Test, Cs', 30, 131.67, '2025-11-18', '2027-06-25', 10),
  ('31', 'Malaria Pf/Pan Ag Rapid Test, Cs', 30, 171.00, '2025-11-18', '2027-12-07',10),
  ('32', 'Typhoid IgG/IgM Combo Rapid Test, Cs', 30, 184.33, '2025-11-18', '2028-07-28',10),
  ('33', 'Rotavirus Ag Rapid Test, Cs', 25, 210.80, '2025-11-18', '2028-08-14',10),
  ('34', 'Dosifix Safeset IV Set', 100, 323.20, '2025-11-18', '2026-06-18',10),
  ('35', 'Intrafix Primeline Basic IV Set', 100, 69.70, '2025-11-18', '2028-04-16',10),
  ('36', 'Intrafix Safeset Caresite IV Set', 100, 150.70, '2025-11-18', '2028-04-15',10),
  ('37', 'Introcan Safety IV Cannula G.18', 50, 89.80, '2025-11-18', '2027-09-21',10),
  ('38', 'Sangofix IV Set', 100, 81.10, '2025-11-18', '2028-01-18',10),
  ('39', 'Spinocan IV Set G. 23', 50, 90.00, '2025-11-18', '2028-04-18',10);
